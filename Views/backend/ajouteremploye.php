...
<head>
    <meta charset="utf-8">
    <title>Ajouter employe | RH </title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">employes</a></li>
                                            <li class="breadcrumb-item active">Ajouter employe</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ajouter employe</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" class="form-control" name="name" placeholder="Nom du employe..." required>
                        </div>

                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" id="email" class="form-control" name="email" placeholder="Email du employe..." required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="image" class="form-control" name="image" placeholder="Lien de l'image du employe..." required>
                        </div>
