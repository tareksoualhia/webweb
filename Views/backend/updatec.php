                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <form method="POST" action="?update=<?=$category['id']?>" class="ps-lg-4">
                                                   
                                                    <div class="mt-4">
                                                        <h3 class="font-14">nom :</h3>
                                                        <h6><input type="text" name="name" value="<?= $category['name'] ?>" required></h6>
                                                    </div>
                                                    <div class="mt-4">
                                                        <h3 class="font-14">description :</h3>
                                                        <h6><input type="text" name="description" value="<?= $category['description'] ?>" required></h6>
                                                    </div>
