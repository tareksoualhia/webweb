...
<head>
    <meta charset="utf-8">
    <title>Ajouter Produits | GreenLand </title>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="nom" class="form-control" name="nom" placeholder="nom produit ..." required>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="quantité" class="form-label" >quantité</label>
                                                    <input type="number" id="quantité" class="form-control" name="quantité" placeholder="quantité..." required>
                                                </div>


                                                <div class="mb-3">
                                                    <label for="description" class="form-label">Description</label>
                                                    <textarea name="description" class="form-control" id="description" name="produit_descripton" rows="5" placeholder="description de la produit.."></textarea>
                                                </div>
                                                ...
                                                <div class="mb-3 position-relative" id="datepicker1">
                                                    ...
                                                    <div class="d-flex">
                                                        <input name="prix" type="number"  class="form-control" placeholder="prix produit ..." required>
                                                    </div>
                                                </div>
