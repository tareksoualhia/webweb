...
<head>
    <meta charset="utf-8">
    <title>Ajouter formation | RH </title>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="nom" class="form-control" name="nom" placeholder="nom formation ..." required>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="formateur" class="form-label" >Formateur</label>
                                                    <input type="text" id="formateur" class="form-control" name="formateur" placeholder="nom formateur ..." required>
                                                </div>


                                                <div class="mb-3">
                                                    <label for="description" class="form-label">Description</label>
                                                    <textarea name="description" class="form-control" id="description" name="formation_descripton" rows="5" placeholder="description de la formation.."></textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="lien" class="form-control" name="lien" required>
                                                </div>

                                                <div class="mb-3 position-relative" id="datepicker1">
                                                    <label for="prix" class="form-label">Prix</label>
                                                    <div class="d-flex">
                                                        <input name="prix" type="number" min="1" value="1" class="form-control" placeholder="prix formation ..." required>
                                                    </div>
                                                </div>
