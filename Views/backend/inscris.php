                                            ...
                                            <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                                                ...
                                                <?php foreach ($resultp as $user) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="infof.php?detail=<?=$user['id_formation']?>"><?=$user['id_formation']?></a>
                                                        </td>
                                                        <td>
                                                            <a href="inscris.php?delete=<?=$user['id_participant']?>" class="action-icon"> <i class="mdi mdi-delete"></i>supprimer</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach ?>
                                                </tbody>
