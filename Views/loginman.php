...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // Query to find the manager by their email
        ...
        if ($manager && $password === $manager['password']) {
            ...
            header("Location: http://localhost/ta/views/index1.php"); // Redirect to the manager's dashboard after successful login
            exit();
        } else {
...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h2 class="text-center text-dark mt-5">Manager Login Form</h2>
